...
-   **`GET /api/doctors/:id`**
    -   **الوصف:** جلب بيانات ملف شخصي كامل لطبيب واحد (يجب أن يكون الطبيب موثقًا `verified`). إذا لم يكن موثقًا، يتم إرجاع `404 Not Found`.
...
## 8. نظام الإبلاغ عن الأدوية الناقصة
