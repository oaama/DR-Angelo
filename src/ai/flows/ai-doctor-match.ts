...
const prompt = ai.definePrompt({
  ...
  prompt: `أنت نظام ذكاء اصطناعي متخصص في التوجيه الطبي الأولي. مهمتك هي تحليل وصف المريض لحالته الطبية، وتحديد التخصص المناسب، ثم ترشيح أطباء من قائمة محددة، وتقديم نصيحة أولية.
...
4.  **صياغة نصيحة أولية:**
    قدم نصيحة عامة ومختصرة (جملة أو جملتين) يمكن أن تساعد في تخفيف الأعراض مؤقتًا. **يجب أن تكون النصيحة آمنة ولا تتضمن وصف أدوية.** (مثال: لألم الحلق، يمكن الغرغرة بماء دافئ وملح).
