    ...
    <footer className="border-t py-6 md:py-8">
      <div className="container mx-auto px-4 md:px-6 flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-4 text-sm text-muted-foreground">
            ...
            <a href="https://wa.me/201228668228" target="_blank" rel="noopener noreferrer" aria-label="Contact on WhatsApp" className="text-muted-foreground hover:text-green-500 transition-colors">
